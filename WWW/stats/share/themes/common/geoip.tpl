...
<!--end:admin--><!--start:singlecountry--><table cellpadding="0" cellspacing="0" id="geoip">
<tr>
<td>
{cities}</td>
<td>
...
<!--end:singlecountry--><!--start:!singlecountry--><table cellpadding="0" cellspacing="0" id="geoip">
<tr>
<td>
{cities}</td>
<td>
